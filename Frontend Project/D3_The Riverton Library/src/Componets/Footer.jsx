  ...
  <div className="container px-6 pt-6">
    ...
    <div>
      <form action="">
        <div
          ...
          <div className="relative md:mb-6 border border-emerald-50" data-te-input-wrapper-init>
            <input
              type="text"
    ...
    <div className="mb-6">
      <p className='text-3xl'>
        Empower Your Community Through Knowledge.
      </p>
    </div>
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3">
      <div className="mb-6">
        ...
        <ul className="mb-0 list-none">
          ...
          <li>
            <a href="#!" className="text-white">Historical</a>
          </li>
          <li>
            <a href="#!" className="text-white">Biography</a>
          </li>
          <li>
            <a href="#!" className="text-white">Auto Biography</a>
          </li>
        </ul>
      </div>
      ...
      <div className="mb-6">
        ...
        <ul className="mb-0 list-none">
          ...
          <li>
            <a href="#!" className="text-white">Politics</a>
          </li>
          <li>
        ...
        <ul className="mb-0 list-none">
          ...
          <li>
            <a href="#!" className="text-white">Environmnet</a>
          </li>
        </ul>
      </div>

...
export const Testimonials = () => {
  ...
  <div class="grid sm:grid-cols-2 items-center gap-4 font-[sans-serif] text-[#333] max-w-5xl mx-auto min-h-screen">
    <div class="sm:h-[400px] px-4 max-sm:pt-4">
        <img src="bg5.jpg" class="w-full h-full object-contain" />
    </div>
    <div class="p-4">
        <h3 class="text-xl font-semibold">Exceptional Service: Best Digital Campaigns and iSkills workshop.</h3>
        <p class="mt-4 text-sm text-gray-400">The service was amazing.The Digital Book zone and community is exceptional. The staff was friendly and attentive.</p>
        <div class="mt-8 text-left">
            <h4 class="text-sm font-semibold">Shaun Kane</h4>
            <p class="text-xs text-gray-400">CEO of XYZ Company</p>
        </div>
